...
break;default:simpleCart.customCheckout()}};a.paypalCheckout=function(){var a="https://www.paypal.com/cgi-bin/webscr?cmd=_cart&upload=1&business="+this.email+"&currency_code="+this.currency,b=1,d="";this.taxRate&&(a=a+"&tax_cart="+this.currencyStringForPaypalCheckout(this.taxCost));for(var f in this.items){var e=this.items[f],g="",h;for(h in e)typeof e[h]!="function"&&h!="id"&&h!="price"&&h!="quantity"&&h!="name"&&h!="shipping"&&(g=g+", "+h+"="+e[h]);g=g.substring(2);d=d+"&item_name_"+b+"="+e.name+
"&item_number_"+b+"="+b+"&quantity_"+b+"="+e.quantity+"&amount_"+b+"="+this.currencyStringForPaypalCheckout(e.price)+"&on0_"+b+"=Options&os0_"+b+"="+g;b++}this.shipping()!=0&&(d=d+"&item_name_"+b+"=Shipping&item_number_"+b+"="+b+"&quantity_"+b+"=1&amount_"+b+"="+this.currencyStringForPaypalCheckout(this.shippingCost));this.successUrl&&(d=d+"&return="+this.successUrl);this.cancelUrl&&(d=d+"&cancel_return="+this.cancelUrl);a+=d;window.open(a,"paypal","scrollbars,location,resizable,status")};a.googleCheckout=
function(){if(this.currency!=USD&&this.currency!=GBP)error("Google Checkout only allows the USD and GBP for currency.");else if(this.merchantId===""||this.merchantId===null||!this.merchantId)error("No merchant Id for google checkout supplied.");else{var a=document.createElement("form"),b=1;a.style.display="none";a.method="POST";a.action="https://checkout.google.com/api/checkout/v2/checkoutForm/Merchant/"+this.merchantId;a.acceptCharset="utf-8";for(var d in this.items){var f=this.items[d];a.appendChild(this.createHiddenElement("item_name_"+
