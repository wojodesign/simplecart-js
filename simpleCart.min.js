...
total:function(){return this.quantity()*this.price()}};b.extend({checkout:function(){"custom"===k.checkout.type.toLowerCase()&&h(k.checkout.fn)?k.checkout.fn.call(b,k.checkout):h(b.checkout[k.checkout.type])?b.checkout[k.checkout.type].call(b,k.checkout):b.error("No Valid Checkout Method Specified")},extendCheckout:function(a){return b.extend(b.checkout,a)},generateAndSendForm:function(a){var d=b.$create("form");d.attr("style","display:none;");d.attr("action",a.action);d.attr("method",a.method);b.each(a.data,
function(a,g,e){d.append(b.$create("input").attr("type","hidden").attr("name",e).val(a))});b.$("body").append(d);d.el.submit();d.remove()}});b.extendCheckout({PayPal:function(a){if(!a.email)return b.error("No email provided for PayPal checkout");var d={cmd:"_cart",upload:"1",currency_code:b.currency().code,business:a.email,rm:"GET"===a.method?"0":"2",tax_cart:b.tax(),handling_cart:b.shipping(),charset:"utf-8"},c=a.sandbox?"https://www.sandbox.paypal.com/cgi-bin/webscr":"https://www.paypal.com/cgi-bin/webscr",
g="GET"===a.method?"GET":"POST";a.success&&(d["return"]=a.success);a.cancel&&(d.cancel_return=a.cancel);b.each(function(a,c){var g=c+1,e=a.options(),f=0,h;d["item_name_"+g]=a.get("name");d["quantity_"+g]=a.quantity();d["amount_"+g]=a.price();d["item_number_"+g]=a.get("item_number")||g;b.each(e,function(a,c,e){if(c<10){h=true;b.each(k.excludeFromCheckout,function(a){a===e&&(h=false)});if(h){f=f+1;d["on"+c+"_"+g]=e;d["os"+c+"_"+g]=a}}});d["option_index_"+c]=Math.min(10,f)});b.trigger("beforeCheckout",
[d]);b.generateAndSendForm({action:c,method:g,data:d})},GoogleCheckout:function(a){if(!a.merchantID)return b.error("No merchant id provided for GoogleCheckout");if("USD"!==b.currency().code&&"GBP"!==b.currency().code)return b.error("Google Checkout only accepts USD and GBP");var d={ship_method_name_1:"Shipping",ship_method_price_1:b.shipping(),ship_method_currency_1:b.currency().code,_charset_:""},c="https://checkout.google.com/api/checkout/v2/checkoutForm/Merchant/"+a.merchantID,a="GET"===a.method?
"GET":"POST";b.each(function(a,c){var e=c+1,f=[],h;d["item_name_"+e]=a.get("name");d["item_quantity_"+e]=a.quantity();d["item_price_"+e]=a.price();d["item_currency_ "+e]=b.currency().code;d["item_tax_rate"+e]=a.get("taxRate")||b.taxRate();b.each(a.options(),function(a,d,c){h=!0;b.each(k.excludeFromCheckout,function(a){a===c&&(h=!1)});h&&f.push(c+": "+a)});d["item_description_"+e]=f.join(", ")});b.trigger("beforeCheckout",[d]);b.generateAndSendForm({action:c,method:a,data:d})},AmazonPayments:function(a){if(!a.merchant_signature)return b.error("No merchant signature provided for Amazon Payments");
if(!a.merchant_id)return b.error("No merchant id provided for Amazon Payments");if(!a.aws_access_key_id)return b.error("No AWS access key id provided for Amazon Payments");var d={aws_access_key_id:a.aws_access_key_id,merchant_signature:a.merchant_signature,currency_code:b.currency().code,tax_rate:b.taxRate(),weight_unit:a.weight_unit||"lb"},c=(a.sandbox?"https://sandbox.google.com/checkout/":"https://checkout.google.com/")+"cws/v2/Merchant/"+a.merchant_id+"/checkoutForm",e="GET"===a.method?"GET":
"POST";b.each(function(c,e){var g=e+1,f=[];d["item_title_"+g]=c.get("name");d["item_quantity_"+g]=c.quantity();d["item_price_"+g]=c.price();d["item_sku_ "+g]=c.get("sku")||c.id();d["item_merchant_id_"+g]=a.merchant_id;c.get("weight")&&(d["item_weight_"+g]=c.get("weight"));k.shippingQuantityRate&&(d["shipping_method_price_per_unit_rate_"+g]=k.shippingQuantityRate);b.each(c.options(),function(a,d,c){var g=true;b.each(k.excludeFromCheckout,function(a){a===c&&(g=false)});g&&(c!=="weight"&&c!=="tax")&&
f.push(c+": "+a)});d["item_description_"+g]=f.join(", ")});b.trigger("beforeCheckout",[d]);b.generateAndSendForm({action:c,method:e,data:d})},SendForm:function(a){if(!a.url)return b.error("URL required for SendForm Checkout");var d={currency:b.shipping(),shipping:b.currency().code,tax:b.tax(),taxRate:b.taxRate(),itemCount:b.find({}).length},c=a.url,g="GET"===a.method?"GET":"POST";b.each(function(a,c){var g=c+1,e=[],f;d["item_name_"+g]=a.get("name");d["item_quantity_"+g]=a.quantity();d["item_price_"+
g]=a.price();b.each(a.options(),function(a,d,c){f=!0;b.each(k.excludeFromCheckout,function(a){a===c&&(f=!1)});f&&e.push(c+": "+a)});d["item_options_"+g]=e.join(", ")});a.success&&(d["return"]=a.success);a.cancel&&(d.cancel_return=a.cancel);a.extra_data&&(d=b.extend(d,a.extra_data));b.trigger("beforeCheckout",[d]);b.generateAndSendForm({action:c,method:g,data:d})}});n={bind:function(a,b){if(!h(b))return this;this._events||(this._events={});!0===this._events[a]?b.apply(this):e(this._events[a])?this._events[a]=
[b]:this._events[a].push(b);return this},trigger:function(a,b){var c=!0,g,f;this._events||(this._events={});if(!e(this._events[a])&&h(this._events[a][0])){g=0;for(f=this._events[a].length;g<f;g+=1)c=this._events[a][g].apply(this,b||[])}return!1===c?!1:!0}};b.extend(n);b.extend(b.Item._,n);n={beforeAdd:null,afterAdd:null,load:null,beforeSave:null,afterSave:null,update:null,ready:null,checkoutSuccess:null,checkoutFail:null,beforeCheckout:null,beforeRemove:null};b(n);b.each(n,function(a,d,c){b.bind(c,
function(){h(k[c])&&k[c].apply(this,arguments)})});b.extend({toCurrency:function(a,d){var c=parseFloat(a),g=d||{},g=b.extend(b.extend({symbol:"$",decimal:".",delimiter:",",accuracy:2,after:!1},b.currency()),g),e=c.toFixed(g.accuracy).split("."),c=e[1],e=e[0],e=b.chunk(e.reverse(),3).join(g.delimiter.reverse()).reverse();return(!g.after?g.symbol:"")+e+(c?g.decimal+c:"")+(g.after?g.symbol:"")},chunk:function(a,b){"undefined"===typeof b&&(b=2);return a.match(RegExp(".{1,"+b+"}","g"))||[]}});String.prototype.reverse=
function(){return this.split("").reverse().join("")};b.extend({currency:function(a){if(i(a,p)&&!e(A[a]))k.currency=a;else if(i(a,"object"))A[a.code]=a,k.currency=a.code;else return A[k.currency]}});b.extend({bindOutlets:function(a){b.each(a,function(a,c,g){b.bind("update",function(){b.setOutlet("."+u+"_"+g,a)})})},setOutlet:function(a,d){var c=d.call(b,a);i(c,"object")&&c.el?b.$(a).html(" ").append(c):e(c)||b.$(a).html(c)},bindInputs:function(a){b.each(a,function(a){b.setInput("."+u+"_"+a.selector,
a.event,a.callback)})},setInput:function(a,d,c){b.$(a).live(d,c)}});b.ELEMENT=function(a){this.create(a);this.selector=a||null};b.extend(w,{MooTools:{text:function(a){return this.attr("text",a)},html:function(a){return this.attr("html",a)},val:function(a){return this.attr("value",a)},attr:function(a,b){if(e(b))return this.el.get(a);this.el.set(a,b);return this},remove:function(){this.el.dispose();return null},addClass:function(a){this.el.addClass(a);return this},removeClass:function(a){this.el.removeClass(a);
return this},append:function(a){this.el.adopt(a.el);return this},each:function(a){h(a)&&b.each(this.el,a);return this},click:function(a){h(a)?this.each(function(b){b.addEvent("click",function(c){a.call(b,c)})}):e(a)&&this.el.fireEvent("click");return this},live:function(a,d){var c=this.selector;h(d)&&b.$(f).el.addEvent(a,function(a){var e=b.$(a.target);e.match(c)&&d.call(e,a)})},match:function(a){return this.el.match(a)},parent:function(){return b.$(this.el.getParent())},find:function(a){return b.$(this.el.getElements(a))},
closest:function(a){return b.$(this.el.getParent(a))},descendants:function(){return this.find("*")},tag:function(){return this.el[0].tagName},create:function(a){this.el=x(a)}},Prototype:{text:function(a){if(e(a))return this.el[0].innerHTML;this.each(function(b){$(b).update(a)});return this},html:function(a){return this.text(a)},val:function(a){return this.attr("value",a)},attr:function(a,b){if(e(b))return this.el[0].readAttribute(a);this.each(function(c){$(c).writeAttribute(a,b)});return this},append:function(a){this.each(function(b){a.el?
a.each(function(a){$(b).appendChild(a)}):v(a)&&$(b).appendChild(a)});return this},remove:function(){this.each(function(a){$(a).remove()});return this},addClass:function(a){this.each(function(b){$(b).addClassName(a)});return this},removeClass:function(a){this.each(function(b){$(b).removeClassName(a)});return this},each:function(a){h(a)&&b.each(this.el,a);return this},click:function(a){h(a)?this.each(function(b){$(b).observe("click",function(c){a.call(b,c)})}):e(a)&&this.each(function(a){$(a).fire("click")});
