...
function(a,b,d){return"<"+a+" "+d+" > "+b+"</"+a+">"};a.hasItem=function(c){for(var b in a.items){var d=a.items[b],f=!0,e;for(e in c)typeof c[e]!="function"&&e!="quantity"&&e!="id"&&c[e]!=d[e]&&(f=!1);if(f)return b}return!1};a.ln={en_us:{quantity:"Quantity",price:"Price",total:"Total",decrement:"Decrement",increment:"Increment",remove:"Remove",tax:"Tax",shipping:"Shipping",image:"Image"}};a.language="en_us";a.print=function(a){return this.ln[this.language]&&this.ln[this.language][a.toLowerCase()]?
this.ln[this.language][a.toLowerCase()]:a};a.update=function(){simpleCart.isLoaded||simpleCart.load();simpleCart.pageIsReady||simpleCart.initializeView();a.updateTotals();a.updateView();a.save()};a.updateTotals=function(){a.total=0;a.quantity=0;for(var c in a.items){var b=a.items[c];if(b.quantity<1)b.remove();else if(b.quantity!==null&&b.quantity!="undefined")a.quantity=parseInt(a.quantity,10)+parseInt(b.quantity,10);if(b.price)a.total=parseFloat(a.total)+parseInt(b.quantity,10)*parseFloat(b.price)}a.shippingCost=
a.shipping();a.taxCost=parseFloat(a.total)*a.taxRate;a.finalTotal=a.shippingCost+a.taxCost+a.total};a.shipping=function(){if(parseInt(a.quantity,10)===0)return 0;var c=parseFloat(a.shippingFlatRate)+parseFloat(a.shippingTotalRate)*parseFloat(a.total)+parseFloat(a.shippingQuantityRate)*parseInt(a.quantity,10),b,d;for(d in a.items)b=a.items[d],b.shipping&&(c+=typeof b.shipping=="function"?parseFloat(b.shipping()):parseFloat(b.shipping));return c};a.initialize=function(){simpleCart.initializeView();
simpleCart.load();simpleCart.update()}}function CartItem(){for(;simpleCart.items["c"+simpleCart.nextId];)simpleCart.nextId++;this.id="c"+simpleCart.nextId}
