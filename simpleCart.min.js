...
c&&(b[a.id]=a)});this.items=b};a.empty=function(){a.items={};a.update()};a.find=function(c){if(!c)return null;var b=[];a.each(function(d){fits=!0;a.each(c,function(a,c,b){if(!d[b]||d[b]!=a)fits=!1});fits&&b.push(d)});return b.length===0?null:b};a.each=function(c,b){var d,e=0,g;if(typeof c==="function")var h=c,f=a.items;else if(typeof b==="function")var h=b,f=c;else return;for(d in f)if(typeof f[d]!=="function"){g=h.call(a,f[d],e,d);if(g===!1)break;e++}};a.chunk=function(a,b){typeof b==="undefined"&&
(b=2);return a.match(RegExp(".{1,"+b+"}","g"))||[]};a.checkout=function(){if(a.quantity===0)error("Cart is empty");else switch(a.checkoutTo){case PayPal:a.paypalCheckout();break;case GoogleCheckout:a.googleCheckout();break;case Email:a.emailCheckout();break;default:a.customCheckout()}};a.paypalCheckout=function(){var a=this,b="https://www.paypal.com/cgi-bin/webscr?cmd=_cart&upload=1&business="+a.email+"&currency_code="+a.currency,d=1,e="",g;a.taxRate&&(b=b+"&tax_cart="+a.currencyStringForPaypalCheckout(a.taxCost));
a.each(function(b,f){d=f+1;g="";a.each(b,function(a,c,b){b!=="id"&&b!=="price"&&b!=="quantity"&&b!=="name"&&b!=="shipping"&&(g=g+", "+b+"="+a)});g=g.substring(2);e=e+"&item_name_"+d+"="+b.name+"&item_number_"+d+"="+d+"&quantity_"+d+"="+b.quantity+"&amount_"+d+"="+a.currencyStringForPaypalCheckout(b.price)+"&on0_"+d+"=Options&os0_"+d+"="+g});a.shipping()!==0&&(e=e+"&shipping="+a.currencyStringForPaypalCheckout(a.shippingCost));a.successUrl&&(e=e+"&return="+a.successUrl);a.cancelUrl&&(e=e+"&cancel_return="+
a.cancelUrl);b+=e;window.open(b,"paypal","scrollbars,location,resizable,status")};a.googleCheckout=function(){var a=this;if(a.currency!==USD&&a.currency!==GBP)error("Google Checkout only allows the USD and GBP for currency.");else if(a.merchantId===""||a.merchantId===null||!a.merchantId)error("No merchant Id for google checkout supplied.");else{var b=document.createElement("form"),d=1,e;b.style.display="none";b.method="POST";b.action="https://checkout.google.com/api/checkout/v2/checkoutForm/Merchant/"+
a.merchantId;b.acceptCharset="utf-8";a.each(function(g,h){d=h+1;b.appendChild(a.createHiddenElement("item_name_"+d,g.name));b.appendChild(a.createHiddenElement("item_quantity_"+d,g.quantity));b.appendChild(a.createHiddenElement("item_price_"+d,g.price));b.appendChild(a.createHiddenElement("item_currency_"+d,a.currency));b.appendChild(a.createHiddenElement("item_tax_rate_"+d,a.taxRate));b.appendChild(a.createHiddenElement("_charset_",""));e="";a.each(g,function(a,b,c){c!=="id"&&c!=="quantity"&&c!==
"price"&&(e=e+", "+c+": "+a)});e=e.substring(1);b.appendChild(a.createHiddenElement("item_description_"+d,e))});a.shipping()!==0&&(b.appendChild(a.createHiddenElement("ship_method_name_1","Shipping")),b.appendChild(a.createHiddenElement("ship_method_price_1",parseFloat(a.shippingCost).toFixed(2))),b.appendChild(a.createHiddenElement("ship_method_currency_1",a.currency)));document.body.appendChild(b);b.submit();document.body.removeChild(b)}};a.emailCheckout=function(){};a.customCheckout=function(){};
...
"Outlets",g,h=0,f=a[e].length;h<f;h++){switch(c[b][1]){case "none":g=""+a[c[b][0]];break;case "currency":g=a.valueToCurrencyString(a[c[b][0]]);break;case "percentage":g=a.valueToPercentageString(a[c[b][0]]);break;default:g=""+a[c[b][0]]}a[e][h].innerHTML=""+g}};a.updateCartView=function(){var c=[],b,d,e,g,h,f;d=document.createElement("div");b=0;for(var i=a.cartHeaders.length;b<i;b++){e=document.createElement("div");f=a.cartHeaders[b].split("_");e.innerHTML=a.print(f[0]);e.className="item"+f[0];for(var j=
1,k=f.length;j<k;j++)if(f[j].toLowerCase()=="noheader")e.style.display="none";d.appendChild(e)}d.className="cartHeaders";c[0]=d;a.each(function(b,f){d=document.createElement("div");for(var i=0,j=a.cartHeaders.length;i<j;i++)e=document.createElement("div"),g=a.cartHeaders[i].split("_"),h=a.createCartRow(g,b,h),e.innerHTML=h,e.className="item"+g[0],d.appendChild(e);d.className="itemContainer";c[f+1]=d});b=0;for(f=a.cartDivs.length;b<f;b++)if(i=a.cartDivs[b],i.childNodes&&i.appendChild){for(;i.childNodes[0];)i.removeChild(i.childNodes[0]);
j=0;for(k=c.length;j<k;j++)i.appendChild(c[j])}};a.createCartRow=function(c,b,d){switch(c[0].toLowerCase()){case "total":d=a.valueToCurrencyString(parseFloat(b.price)*parseInt(b.quantity,10));break;case "increment":d=a.valueToLink("+","javascript:;","onclick=\"simpleCart.items['"+b.id+"'].increment();\"");break;case "decrement":d=a.valueToLink("-","javascript:;","onclick=\"simpleCart.items['"+b.id+"'].decrement();\"");break;case "remove":d=a.valueToLink("Remove","javascript:;","onclick=\"simpleCart.items['"+
